...
{
    public class RedcapColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            if (opg != null)
            {
                ...
                if (arkiv.Redcap == DateTime.Parse("01-01-1995") && rute.Ankomst > DateTime.Now)
                    return white;
                if (arkiv.Redcap == DateTime.Parse("01-01-1995"))
                    return red;
                if (rute.Ankomst > DateTime.Now)
                    return white;
                if (arkiv.Redcap > rute.Afgang)
                    return yellow;
                if (arkiv.Redcap < rute.Afgang)
                    return green;
                if (arkiv.Redcap == null)
                    return white;
            }
            return null;
        }
